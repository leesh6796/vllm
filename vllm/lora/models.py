    ...
    def from_local_checkpoint(
        ...
        *,
        ...
        if os.path.isfile(new_embeddings_tensor_path):
            ...
            embeddings = torch.load(new_embeddings_bin_file_path, map_location=device)
        ...
        if context_length:
            ...
            scaling_factor = float(math.ceil(context_length / max_position_embeddings))
...
class LoRAModelManager(AdapterModelManager):
    ...
    def __init__(
        ...
        self.punica_wrapper = PunicaWrapper(
            max_num_batched_tokens, max_batches=self.max_num_seqs, device="cuda"
        )
    ...
    def _set_long_lora_context(self, lora: LoRAModel):
        ...
        if lora.scaling_factor not in self.scaling_factor_to_offset:
            raise ValueError(
                f"Long LoRA scaling factor {lora.scaling_factor}"
    ...
    def _create_lora_modules(self):
        for module_name, module in self.model.named_modules(remove_duplicate=False):
            ...
            if isinstance(new_module, LinearScalingRotaryEmbeddingWithLora):
                ...
                self.scaling_factor_to_offset = new_module.scaling_factor_to_offset
    ...
    def _filter_unsupported_mm_module(self, module_name: str) -> bool:
        ...
        if self.supports_mm:
            ...
            return (
                prefix in module_mapping.connector
...
class LRUCacheLoRAModelManager(LoRAModelManager):
    ...
    def _pin_lora_in_cpu_cache(self, lora_id: int):
        try:
            ...
            raise ValueError(
                "Pinning failed. " f"LoRA {lora_id} is not registered."
            ) from err
