    ...
    * The scoring forward pass is done without an MQA kernel, which is
    ...
    def create_worker(
        ...
        if ngram_prompt_lookup_max > 0:
            ...
            if (
                draft_worker_kwargs["model_config"].hf_config.model_type
                == "mlp_speculator"
            ):
                proposer_worker = MLPSpeculatorWorker(**draft_worker_kwargs)
            elif draft_worker_kwargs["model_config"].hf_config.model_type == "medusa":
        ...
        if not disable_mqa_scorer:
            ...
            if (
                "model_config" in draft_worker_kwargs
                and draft_worker_kwargs["model_config"].max_model_len
