...
class MllamaVisionSdpaAttention(nn.Module):
    ...
    def forward(
        ...
        with MProfile().NVTX("enc-qkv", "blue"):
        ...
        with MProfile().NVTX("enc-attn", "blue"):
        ...
        with MProfile().NVTX("enc-proj", "blue"):
...
class MllamaVisionEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        with MProfile().NVTX("enc-ffn", "blue"):
...
class MllamaVisionModel(nn.Module):
    ...
    def forward(
        ...
        # patch embedding
        with MProfile().NVTX("patch embedding", "blue"):
        ...
        # tile embeddings
        with MProfile().NVTX("tile embeddings", "blue"):
        ...
        with MProfile().NVTX("pos-embedding", "blue"):
            hidden_state = hidden_state.reshape(
                batch_size * num_concurrent_media, num_tiles, num_patches, dim
            )
        ...
        # apply encoder
        with MProfile().NVTX("encoder", "blue"):
        ...
        with MProfile().NVTX("global encoder", "blue"):
...
class MllamaTextCrossAttention(nn.Module):
    ...
    def forward(
        ...
        with MProfile().NVTX("dec-qkv", "blue"):
            with MProfile().NVTX("q", "blue"):
        ...
        with MProfile().NVTX("dec-cross-attn", "blue"):
        ...
        with MProfile().NVTX("dec-proj", "blue"):
...
class MllamaCrossAttentionDecoderLayer(torch.nn.Module):
    ...
    def forward(
        ...
        with MProfile().NVTX("dec-ffn", "blue"):
    ...
    def forward(
        ...
        for idx, decoder_layer in enumerate(self.layers):
            if isinstance(decoder_layer, MllamaCrossAttentionDecoderLayer):
                with MProfile().NVTX("cross-decoder", "blue"):
                ...
                with MProfile().NVTX("decoder", "blue"):
...
class MllamaForConditionalGeneration(nn.Module, SupportsMultiModal):
    ...
    def __init__(
        ...
        self.vision_model = MllamaVisionModel(
            config.vision_config, quant_config, prefix="vision_model"
        )
    ...
    def get_cross_attention_states(
        ...
        MProfile().nvtx_push_range("Vision model", "blue")
        cross_attention_states = self.vision_model(
            pixel_values, aspect_ratio_ids, aspect_ratio_mask
        )
        MProfile().nvtx_pop_range()

        MProfile().nvtx_push_range("Vision projector", "blue")
    ...
    def forward(
        ...
        **kwargs: object,
        ...
        MProfile().nvtx_push_range("Vision adapter", "yellow")
        ...
        MProfile().nvtx_push_range("LLM", "purple")
