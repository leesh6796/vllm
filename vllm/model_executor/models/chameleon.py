...
def input_processor_for_chameleon(ctx: InputContext, inputs: DecoderOnlyInputs):
    """
...
class ChameleonForConditionalGeneration(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def _validate_pixel_values(self, data: torch.Tensor) -> torch.Tensor:
        ...
        expected_dims = (3, CHAMELEON_CROP_SIZE_HEIGHT, CHAMELEON_CROP_SIZE_WIDTH)
